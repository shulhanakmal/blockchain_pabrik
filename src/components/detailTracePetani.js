...
export default class DetailTracePetani extends Component {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    await UserService.getTraceSales(this.state.petaniId, this.state.salesId, this.state.productId).then((response) => {

      console.log('response', response);

      this.setState({
        sugar: response.data.sugar,
        salesDoc: response.data.sales.id,
        // salesDoc: response.data.sales.no_do,
        petani: response.data.petani,
      });
    ...
    await UserService.getDataProdukDanMitra(this.state.sugar, this.state.salesDoc).then((response) => {
        ...
        <Fragment>
            ...
            <CRow style={{ marginTop: "40px" }}>
                ...
                <CImg
                    ...
                    src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse2.mm.bing.net%2Fth%3Fid%3DOIP.WlbSfUNEM2GRLuxNNnfg6QAAAA%26pid%3DApi&f=1"
                    style={{
                        textAlign: "center",
                ...
                <CCol xs="8" lg="7">
                    <p>
                        <strong>Nama Petani:</strong> {this.state.petani.nama_petani}
                    </p>
                    <p>
                        <strong>Kontak:</strong> {this.state.petani.kontak}
                    </p>
                    <p>
                        <strong>Email:</strong> {this.state.petani.email}
                    </p>
                    <p>
                        <strong>Luas Lahan:</strong> {this.state.petani.luas_lahan} Hektar
                    </p>
                    <p align="center" >
                        <CButton size="sm" color="info" style={{'color': 'white'}} to={`/Detail-mitra-petani-view/${this.state.petaniId}`} target="_blank">
                            Detail
                        </CButton>
                    </p>
