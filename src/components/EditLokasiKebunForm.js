...
const EditLokasiKebunForm = (props) => {
    var { handleSubmit } = props;
    console.log("handleSubmit",handleSubmit);
    const [isOpen, setIsOpen] = useState(false);
    const [lokasi_lat, setLat] = useState(props.DATA.lahan_latitude);
    const [lokasi_lng, setLng] = useState(props.DATA.lahan_longitud);
    const [lokasi_label, setLabel] = useState(props.DATA.lahan_name);
    const [lokasi_title, setTitle] = useState(props.DATA.lahan_inisial);
    ...
    console.log('cek data ini mal', props.DATA);
                    ...
                    <CCardBody>
                        <CRow>
                            <CCol xs={5} md={6} lg={6}>
                                ...
                                <CFormGroup>
                                    <CLabel htmlFor="nf-namaJenis">Luas Lahan (hektar)</CLabel>
                                    <Field
                                        className="textInput pabrik"
                                        name="luas_lahan"
                                        component="input"
                                        type="number"
                                        placeholder={data.luas_lahan}
                                        required={true}
                                    />
                                </CFormGroup>
                                <CFormGroup>
                            ...
                            <CCol xs={5} md={6} lg={6}>
                                ...
                                <CFormGroup>
                                    ...
                                    <Field
                                        ...
                                        type="text"
                                        maxLength="3"
                                        placeholder={data.lahan_inisial}
...
export default reduxForm({
  form: "EditLokasiKebun", // a unique identifier for this form
})(EditLokasiKebunForm);